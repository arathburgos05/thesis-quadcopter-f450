...
public:
    ...
    enum class Number : uint8_t {
		...
		ORIENT_CTRL =  27 // [THESIS] Orientation control mode for the quadcopter
    };
...
class ModeOrientationCtrl : public Mode {
...
protected:
    ...
    const char *name() const override { return "ORIENTATION CTRL"; }
    const char *name4() const override { return "ORCT"; }
